...
if(doEgamma){
  ...
  n3.DrawLatex(0.7, 0.6, "Run 272062    #sqrt{s} = 13 TeV");
  n3.DrawLatex(0.7, 0.55, "Preliminary");
  n4.DrawLatex(0.7, 0.45, "Stream Physics");
...
if(doJets){
 ...
 n3.DrawLatex(0.4, 0.6, "Run 272062 #sqrt{s} = 13 TeV");
 n3.DrawLatex(0.4, 0.55, "Preliminary");
 n4.DrawLatex(0.4, 0.45, "Stream Physics");
